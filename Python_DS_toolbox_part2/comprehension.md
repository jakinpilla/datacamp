...
```
    ...
    ## <generator object <genexpr> at 0x00000000395B0D00>
...
```
    ...
    ## C:/Anaconda3/python.exe:1: SettingWithCopyWarning: 
...
![](comprehension_files/figure-gfm/unnamed-chunk-25-1.png)<!-- -->
...
```
    ...
    ## <bound method NDFrame.head of                         CountryName  ... Total Urban Population
...
```
    ...
    ## Index(['Unnamed: 0', 'CountryName', 'CountryCode', 'Year', 'Total Population',
    ##        'Urban population (% of total)', 'Total Urban Population'],
    ##       dtype='object')
...
![](comprehension_files/figure-gfm/unnamed-chunk-30-1.png)<!-- -->
...
![](comprehension_files/figure-gfm/unnamed-chunk-32-1.png)<!-- -->
